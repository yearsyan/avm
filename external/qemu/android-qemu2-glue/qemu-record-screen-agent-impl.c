...
static const char* start_shared_memory_module_stub(int desiredFps) {
    (void)desiredFps;
    return NULL;
}

static bool stop_shared_memory_module_stub(void) {
    return false;
}
#endif
...
#ifdef AEMU_CORE_ONLY
        .startSharedMemoryModule = start_shared_memory_module_stub,
        .stopSharedMemoryModule = stop_shared_memory_module_stub
#else
