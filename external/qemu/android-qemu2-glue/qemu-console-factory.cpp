...
static int coreOnlyGrpcActivePort() {
    return -1;
}

static const QGrpcAgent coreOnlyGrpcAgent = {
        .start = coreOnlyGrpcStart,
        .active_port = coreOnlyGrpcActivePort,
};

extern "C" const QGrpcAgent* const gQGrpcAgent = &coreOnlyGrpcAgent;
#else
